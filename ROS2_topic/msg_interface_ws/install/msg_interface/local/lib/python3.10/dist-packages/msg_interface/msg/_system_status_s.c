...
bool msg_interface__msg__system_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msg_interface.msg._system_status.SystemStatus", full_classname_dest, 45) == 0);
  }
  msg_interface__msg__SystemStatus * ros_message = _ros_message;
  {  // stamp
...
PyObject * msg_interface__msg__system_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("msg_interface.msg._system_status");
