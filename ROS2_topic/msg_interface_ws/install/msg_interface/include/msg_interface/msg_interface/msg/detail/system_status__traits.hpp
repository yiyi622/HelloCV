...
#ifndef MSG_INTERFACE__MSG__DETAIL__SYSTEM_STATUS__TRAITS_HPP_
#define MSG_INTERFACE__MSG__DETAIL__SYSTEM_STATUS__TRAITS_HPP_
...
inline void to_yaml(
  const msg_interface::msg::SystemStatus & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const msg_interface::msg::SystemStatus & msg)
{
  return msg_interface::msg::to_yaml(msg);
}

template<>
inline const char * data_type<msg_interface::msg::SystemStatus>()
{
  return "msg_interface::msg::SystemStatus";
}

template<>
inline const char * name<msg_interface::msg::SystemStatus>()
{
  return "msg_interface/msg/SystemStatus";
}

template<>
struct has_fixed_size<msg_interface::msg::SystemStatus>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<msg_interface::msg::SystemStatus>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<msg_interface::msg::SystemStatus>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // MSG_INTERFACE__MSG__DETAIL__SYSTEM_STATUS__TRAITS_HPP_
