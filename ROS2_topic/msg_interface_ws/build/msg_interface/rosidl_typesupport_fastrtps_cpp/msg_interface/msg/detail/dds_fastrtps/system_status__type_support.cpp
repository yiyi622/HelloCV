...
#include "msg_interface/msg/detail/system_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const msg_interface::msg::SystemStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  msg_interface::msg::SystemStatus & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msg_interface::msg::SystemStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const msg_interface::msg::SystemStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<msg_interface::msg::SystemStatus *>(
    untyped_ros_message);
...
{
  return &msg_interface::msg::typesupport_fastrtps_cpp::_SystemStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_interface, msg, SystemStatus)() {
  return &msg_interface::msg::typesupport_fastrtps_cpp::_SystemStatus__handle;
}
