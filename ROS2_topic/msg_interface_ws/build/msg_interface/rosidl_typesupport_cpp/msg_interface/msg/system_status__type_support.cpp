...
static const _SystemStatus_type_support_symbol_names_t _SystemStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_interface, msg, SystemStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg_interface, msg, SystemStatus)),
  }
};
...
get_message_type_support_handle<msg_interface::msg::SystemStatus>()
{
  return &::msg_interface::msg::rosidl_typesupport_cpp::SystemStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, msg_interface, msg, SystemStatus)() {
  return get_message_type_support_handle<msg_interface::msg::SystemStatus>();
}
